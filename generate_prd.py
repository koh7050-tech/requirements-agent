...
<!-- 저장 버튼 바 (화면에서만 표시) -->
<div class="print-bar">
  <span>아래 버튼을 클릭하면 PDF 파일로 저장됩니다.</span>
  <button class="btn-print" id="btn-save" onclick="savePdf()">PDF로 저장</button>
</div>

<div class="doc">

  <!-- 타이틀 -->
  <div class="doc-title">Project requirements</div>
  <div class="doc-desc">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.10.1/html2pdf.bundle.min.js" integrity="sha512-GsLlZN/3F2ErC5ifS5QtgpiJtWd43JWSuIgh7mbzZ8zBps+dvLusV+eNQATqgA/HdeKFVgA5v3S/cIrLF7QnQ==" crossorigin="anonymous"></script>
<script>
  function savePdf() {{
    var btn = document.getElementById('btn-save');
    btn.disabled = true;
    btn.textContent = '저장 중...';
    var element = document.querySelector('.doc');
    var opt = {{
      margin:      [15, 18, 15, 18],
      filename:    'Project_Requirements_{project}.pdf',
